...
const one = () =>{
    if(document.querySelector("#display").value == " "){
        document.querySelector("#dispplay").value = "1";
    }
    else{
...
const two = () =>{
    if(document.querySelector("#display").value == " "){
        document.querySelector("#dispplay").value = "2";
    }
    else{
...
const three = () =>{
    if(document.querySelector("#display").value == " "){
        document.querySelector("#dispplay").value = "3";
    }
    else{
...
const four = () =>{
    if(document.querySelector("#display").value == " "){
        document.querySelector("#dispplay").value = "4";
    }
    else{
...
const five = () =>{
    if(document.querySelector("#display").value == " "){
        document.querySelector("#dispplay").value = "5";
    }
    else{
...
const six = () =>{
    if(document.querySelector("#display").value == " "){
        document.querySelector("#dispplay").value = "6";
    }
    else{
...
const seven = () =>{
    if(document.querySelector("#display").value == " "){
        document.querySelector("#dispplay").value = "7";
    }
    else{
...
const eight = () =>{
    if(document.querySelector("#display").value == " "){
        document.querySelector("#dispplay").value = "8";
    }
    else{
...
const nine = () =>{
    if(document.querySelector("#display").value == " "){
        document.querySelector("#dispplay").value = "9";
    }
    else{
...
const zero = () =>{
    if(document.querySelector("#display").value == " "){
        document.querySelector("#dispplay").value = "0";
    }
    else{
...
const point = () =>{
    if(document.querySelector("#display").value == " "){
        document.querySelector("#dispplay").value = ".";
    }
    else{
